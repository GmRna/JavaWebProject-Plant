...
<head>
    ...
    $(function(){
		...
		// 신고하기
		var board_no = ${data.free_no};
		$("#reportBtn").click(function() {
			$.ajax ({
				url : '/plant/report.do',
				method : 'get',
				data : {
					board_no : ${data.free_no},
                ...
                <div class="bbs">
                        ...
                        <div class="title">
                            <dl>
                              <dt>${data.free_title }</dt>
                                <dd class="date"><fmt:formatDate value="${data.free_regdate}" pattern="yyyy-MM-dd"/></dd>
                                <dd class="viewcount"> 조회수 : ${data.free_viewcount }</dd>
                            </dl>
                        </div>
                        <div class="cont">
                        	<p>${data.free_content }</p> 
                        </div>
                        <!-- report -->
                    ...
                    <form method="post" name="frm" id="frm" action="" enctype="multipart/form-data" >
                        <table class="board_write">
                            ...
                            <tr>
                                <td>
                                   	<c:if test=" ${empty loginUserInfo}">로그인이 필요합니다.</c:if>
