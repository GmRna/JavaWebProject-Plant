         ...
         <div class="allmenu">전체메뉴
            <div class="allmenu_con">
               ...
               <dl style="width:12.5%;">
                  ...
                  <dd class="frist"><a href="javascript:;" onclick="clickMenu('portfolio1', '신고 게시판', '/reportList.do', false)">신고 게시판</a></dd>
               </dl>
               <dl style="width:12.5%;">
                  <dt><a href="javascript:;">도감 게시판</a></dt>
                  <dd class="frist"><a href="javascript:;" onclick="clickMenu('portfolio1', '식물도감', '/plantbookreq/listBookreq.do', false)">식물도감</a></dd>
               </dl>
               <dl style="width:12.5%;">
                  <dt><a href="javascript:;">자유게시판</a></dt>
                  <dd class="frist"><a href="javascript:;" onclick="clickMenu('back1', '자유게시판', '/free/index.do', false)">자유게시판</a></dd>
               </dl>
            </div>
         </div>
         <div class="gnb">
            <dl>
               ...
               <dd class="gnb_submenu">
                  <ul>   
                     <li id="portfolio1_submenu" onclick="clickMenu('portfolio1', '식물도감', '/plantbookreq/listBookreq.do', false)">식물 도감</li>
