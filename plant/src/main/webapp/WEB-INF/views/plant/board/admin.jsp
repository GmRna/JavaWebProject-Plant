...
<div id="wrap">
	<div id="header">
		...
		<ul class="topmenu">
			<li class="logout"></li>
			<li class="homepage"><a href="/plant/main/index.do" target="_blank">식물관리통합사이트</a></li>
		</ul>
	</div>
	<!--//header-->
	<div id="container">
		<div id="menuWrap">
			<div class="allmenu">전체메뉴
				<div class="allmenu_con">
					<dl style="width:12.5%;">
						...
						<dd class="frist"><a href="javascript:;" onclick="clickMenu('notice', '공지사항', '/notice/index.do', false)">공지사항</a></dd>
					</dl>
					<dl style="width:12.5%;">
						<dt><a href="javascript:;">회원관리</a></dt>
						<dd class="frist"><a href="javascript:;" onclick="clickMenu('user', '일반회원', '/user/list.do', false)">일반회원</a></dd>
						<dd><a href="javascript:;" onclick="clickMenu('gd', '가드너', '/gd/list.do', false)">가드너</a></dd>
					</dl>
					<dl style="width:12.5%;">
						<dt><a href="javascript:;">커뮤니티</a></dt>
						<dd class="frist"><a href="javascript:;" onclick="clickMenu('quest', '질문 게시판', '/quest/index.do', false)">질문 게시판</a></dd>
						<dd class="frist"><a href="javascript:;" onclick="clickMenu('free', '자유 게시판', '/free/index.do', false)">자유 게시판</a></dd>
					</dl>
					<dl style="width:12.5%;">
						<dt><a href="javascript:;">문의사항</a></dt>
						<dd class="frist"><a href="javascript:;" onclick="clickMenu('ask', '문의사항', '/ask/index2.do', false)">문의사항</a></dd>
					</dl>
					<dl style="width:12.5%;">
						<dt><a href="javascript:;">가드너 파견 서비스</a></dt>
						<dd class="frist"><a href="javascript:;" onclick="clickMenu('explainReserve', '예약 시스템 소개', '/reserve/explainReserve.do', false)">예약 시스템 소개</a></dd>
						<dd><a href="javascript:;" onclick="clickMenu('searchGardener', '가드너 검색', '/reserve/searchGardener.do', false)">가드너 검색</a></dd>
					</dl>
					<dl style="width:12.5%;">
					...
					<dl style="width:12.5%;">
						...
						<dd class="frist"><a href="javascript:;" onclick="clickMenu('plantbook', '식물도감', '/plantbook/main.do', false)">식물도감</a></dd>
						<dd class="frist"><a href="javascript:;" onclick="clickMenu('plantbookreq', '식물 도감 요청 게시판', '/plantbookreq/listBookreq.do', false)">식물 도감 요청 게시판</a></dd>
					</dl>
				</div>
			</div>
			<div class="gnb">
				<dl>
					...
					<dd class="gnb_submenu">
						<ul>	
							<li id="notice_submenu" onclick="clickMenu('notice', '공지사항', '/notice/index.do', false)">공지사항</li>
						</ul>
					</dd>
					<dt id="plant" class="gnb_menu">회원 관리</dt>
					<dd class="gnb_submenu">
						<ul>	
							<li id="plant1_submenu" onclick="clickMenu('user', '일반회원', '/user/list.do', false)">일반회원</li>
							<li id="plant2_submenu" onclick="clickMenu('gd', '가드너', '/gd/list.do', false)">가드너</li>
						</ul>
					</dd>
					<dt id="front" class="gnb_menu">커뮤니티</dt>
					<dd class="gnb_submenu">
						<ul>	
							<li id="user_submenu" onclick="clickMenu('quest', '질문 게시판', '/quest/index.do', false)">질문 게시판</li>
						</ul>
						<ul>	
							<li id="portfolio1_submenu" onclick="clickMenu('free', '자유 게시판', '/free/index.do', false)">자유 게시판</li>
						</ul>
					</dd>
					<dt id="back" class="gnb_menu">문의사항</dt>
					<dd class="gnb_submenu">
						<ul>	
							<li id="back1_submenu" onclick="clickMenu('askreply', '문의사항', '/askreply/index.do', false)">문의사항</li>
						</ul>
					</dd>
					<dt id="bigdata" class="gnb_menu">가드너 파견 서비스</dt>
					<dd class="gnb_submenu">
						<ul>	
							<li id="bigdata1_submenu" onclick="clickMenu('explainReserve', '예약 시스템 소개', '/reserve/explainReserve.do', false)">예약 시스템 소개</li>
							<li id="bigdata2_submenu" onclick="clickMenu('searchGardener', '가드너 검색', '/reserve/searchGardener.do', false)">가드너 검색</li>							
						</ul>
					</dd>
					...
					<dd class="gnb_submenu">
						<ul>	
							<li id="portfolio1_submenu" onclick="clickMenu('portfolio1', '식물도감', '/plantbook/main.do', false)">식물 도감</li>
			...
			<c:choose>
				<c:when test="${empty loginAdminInfo}"> 
					<li>
						<a href="">로그인</a>
						<ul>
							<li><a href="/plant/admin/login.do">일반 회원 로그인</a></li>
						</ul>
					</li>
				</c:when>
				<c:otherwise> 
					<li>
						<a href="/plant/admin/logout.do"  class="btn">로그아웃</a>
					</li>
				</c:otherwise>
			</c:choose>
