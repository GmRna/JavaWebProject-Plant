...
<body>
	<div class="sub">
		<div class="size">
			<h3 class="sub_title">가드너 회원가입</h3>
			...
			<table class="board_write">
                ...
                <tbody>
                	<tr>
                            <th>*아이디(이메일)</th>
                            <td>
                                <input type="text" name="gd_id" id="gd_id" class="inNextBtn" style="float:left;">
                                <span class="email_check"><a href="javascript:;"  class="btn btn-info m-btn--air" style="float:left; width:auto; clear:none;" id="dupCheckBtn">중복확인</a></span>
                            </td>
                    </tr>
                    <tr>
                            <th>*비밀번호</th>
                            <td><input type="password" name="gd_pwd" id="gd_pwd" style="float:left;"> <span class="ptxt">비밀번호는 숫자, 영문 조합으로 8자 이상으로 입력해주세요.</span> </td>
                    </tr>
					<tr>
                    ...
                    <tr>
                        <th>*복구 이메일</th>
                            <td><input type="text" name="gd_email" id="gd_email" style="float:left;"> <span class="ptxt">복구 이메일은 비밀번호 찾기에 활용됩니다.</span> </td>
                    </tr>
                    <tr>
                        <th>*이름</th>
                            <td>
                            	<input type="text" name="gd_name" id="gd_name" style="float:left;"> 
                            </td>
                    </tr>
                    <tr>
                        <th>*주민등록번호</th>
                            <td>
                                <input type="text" name="gd_regnum" id="gd_regnum" style="float:left;">
                            </td>
					</tr> 
                    <tr>
						  <th class="first">*주소</th>
						  <td colspan="3" class="last">
						      <input type="text" id="gd_postcode" name="gd_postcode" placeholder="우편번호" readonly="readonly" /> 
								<a href="javascript:void(0);" onclick="gd_postcode();return false;" class="btn btn-info m-btn--air">우편번호찾기</a>
						  <br>
						  <span style="line-height:50%"><br></span>
							  <input type="text" id="gd_addr1" name="gd_addr1" placeholder="법정주소" style="width:350px" readonly="readonly" />
							  <input type="text" id="gd_addr2" name="gd_addr2" placeholder="상세주소" style="width:350px" />
						  </td>
						</tr>
                    <tr>
                    	<th>*연락처</th>
                        	<td>
                                <input type="text" name="gd_hp" id="gd_hp" value=""  maxlength="15" style="float:left;">
                            </td>
                    </tr>
                    <tr>
                    	<th>*출장가능지역</th>
